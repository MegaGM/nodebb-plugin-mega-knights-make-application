			...
			<div class="row no-gutters">
				<div class="col-xs-6">
					<div class="form-group">
						...
						<br>
						<input id="apb-char-{charI}-nickname" class="form-control" type="text" placeholder="Kempington">
					</div>
				</div>

				<div class="col-xs-6">
					<div class="form-group">
						<label for="apb-char-{charI}-renames">Ренеймы</label>
						<br>
						<input id="apb-char-{charI}-renames" class="form-control" type="text" placeholder="ShiniDesu, Dopefish">
					</div>
				</div>
			</div>
		...
		<div class="col-xs-12 col-md-4">
			<div class="form-group inline-block">
				...
				<div class="screenshot-placeholder">
					...
					<input id="apb-char-{charI}-screenshot-url-charstats" class="screenshot-url" type="text">
