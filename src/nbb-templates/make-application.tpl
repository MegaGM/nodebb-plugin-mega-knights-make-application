	...
	<div class="col-xs-12 make-application-layout">
		...
		<div class="row welcome-message-layout">
			<div class="col-xs-12 welcome-message">
				...
				<h5 class="header">Что мне следует сделать?</h5>
				<div class="content">
					<strong>1. (~2 мин) Внимательно изучить Кодекс Рыцарей.</strong>
					...
					<br>
					<br>
					<strong>2. (5~15 мин) Заполнить бланк заявления.</strong>
					<br> 
					...
					<br> И не нужно никого искать или покать. Ответственные за рекрутинг люди сами начнут беседу.
					<br>
					<br>
					<br> Постарайся!
					<br>
